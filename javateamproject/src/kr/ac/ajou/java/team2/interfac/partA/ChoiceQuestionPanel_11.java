...
public class ChoiceQuestionPanel_11 extends JPanel {
	...
	public ChoiceQuestionPanel_11() {
		...
		JLabel lblNewLabel_2 = new JLabel("Which of these can not be used for a variable name in Java?");
		lblNewLabel_2.setFont(new Font("宋体", Font.PLAIN, 18));
		Image img = new ImageIcon("q11.jpg").getImage();
		
		A = new JRadioButton("identifier");
		buttonGroup.add(A);
		A.setFont(new Font("宋体", Font.PLAIN, 16));
		
		B = new JRadioButton("keyword");
		buttonGroup.add(B);
		B.setFont(new Font("宋体", Font.PLAIN, 16));
		
		C = new JRadioButton("identifier & keyword");
		buttonGroup.add(C);
