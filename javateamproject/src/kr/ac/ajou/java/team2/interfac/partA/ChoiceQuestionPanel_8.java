...
public class ChoiceQuestionPanel_8 extends JPanel {
	...
	public ChoiceQuestionPanel_8() {
		...
		JLabel lblNewLabel_2 = new JLabel("Which of these is an incorrect array declaration?");
		lblNewLabel_2.setFont(new Font("宋体", Font.PLAIN, 18));

		
		A = new JRadioButton("int arr[] = new int[5]");
		buttonGroup.add(A);
		A.setFont(new Font("宋体", Font.PLAIN, 16));
		
		B = new JRadioButton("int [] arr = new int[5]");
		buttonGroup.add(B);
		B.setFont(new Font("宋体", Font.PLAIN, 16));
		
		C = new JRadioButton("int arr[] = new int[5]");
		buttonGroup.add(C);
		C.setFont(new Font("宋体", Font.PLAIN, 16));
		
		D = new JRadioButton("int arr[] = int [5] new");
		buttonGroup.add(D);
