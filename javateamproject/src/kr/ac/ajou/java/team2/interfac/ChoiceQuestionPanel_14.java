...
public class ChoiceQuestionPanel_14 extends JPanel {
	...
	public ChoiceQuestionPanel_14() {
		...
		JButton btnNewButton = new JButton("A. 0 2 4");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			}
		});
		
		JButton btnNewButton_1 = new JButton("B. 0 2 4 6");
		
		JButton btnNewButton_2 = new JButton("C. Compilation fails at line 2");
		
		JButton btnNewButton_3 = new JButton("D. Compilation fails at line 10");
