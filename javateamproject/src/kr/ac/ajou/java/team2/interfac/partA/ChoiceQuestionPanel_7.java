...
public class ChoiceQuestionPanel_7 extends JPanel {
	...
	public ChoiceQuestionPanel_7() {
		...
		JLabel lblNewLabel_2 = new JLabel("Which of these is long data type literal?");
		lblNewLabel_2.setFont(new Font("宋体", Font.PLAIN, 18));

		
		A = new JRadioButton("0x99fffL");
		buttonGroup.add(A);
		A.setFont(new Font("宋体", Font.PLAIN, 16));
		
		B = new JRadioButton("ABCDEFG");
		buttonGroup.add(B);
		B.setFont(new Font("宋体", Font.PLAIN, 16));
		
		C = new JRadioButton("0x99fffa");
		buttonGroup.add(C);
		C.setFont(new Font("宋体", Font.PLAIN, 16));
		
		D = new JRadioButton("99671246");
		buttonGroup.add(D);
